...
namespace Library2 {
    ...
    public partial class LibraryDataSet : global::System.Data.DataSet {
        ...
        public partial class BookDataTable : global::System.Data.TypedTableBase<BookRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public BookRow AddBookRow(string ISBN, string Title, int Publisher_ID, int Available) {
...
namespace Library2.LibraryDataSetTableAdapters {
    ...
    public partial class BookTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Book] WHERE (([ISBN] = @Original_ISBN) AND ((@IsNull_Publisher_ID = 1 AND [Publisher_ID] IS NULL) OR ([Publisher_ID] = @Original_Publisher_ID)) AND ((@IsNull_Available = 1 AND [Available] IS NULL) OR ([Available] = @Original_Available)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Book] ([ISBN], [Title], [Publisher_ID], [Available]) VALUES (@" +
                "ISBN, @Title, @Publisher_ID, @Available);\r\nSELECT ISBN, Title, Publisher_ID, Ava" +
                "ilable FROM Book WHERE (ISBN = @ISBN)";
...
SELECT ISBN, Title, Publisher_ID, Available FROM Book WHERE (ISBN = @ISBN)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ISBN, Title, Publisher_ID, Available FROM dbo.Book";
